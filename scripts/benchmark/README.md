...
| [Stage 2 maintainability-refactor gate](results/2026-07-24-step2-maintainability-refactor.md) | N2 release/regression validation; matched N=500,000, P=8 quantitative, binary, and survival CPU A/B; A100 CUDA conformance | Final revision `1f2352d` produced 48/48 byte-identical association-file pairs, changed CPU wall time by -1.80% to -0.05%, and passed primary CPU/CUDA conformance |
